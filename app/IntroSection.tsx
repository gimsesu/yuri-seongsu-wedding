    ...
    >
      <div className={"max-w-[800px] mx-auto my-0"}>
        ...
        <div className={"justify-center"}>
          <p className={"pb-2"}>열한 번째 가을을 맞이하며 결혼합니다.</p>
          <p className={"pb-2"}>앞으로 주어진 계절들도 기대가 됩니다.</p>
          <p className={"pb-2"}>서로의 고유한 빛을 지켜주며 만났습니다.</p>
          <p className={"pb-2"}>어제와 같이 오늘도 다정하게 손을 잡고</p>
          <p className={"pb-2"}>언제나 삶의 멋진 여정을 함께하겠습니다.</p>
        </div>
        <br />
